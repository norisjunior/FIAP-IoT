...
Use o mesmo firmware preparado no [app15](../app15-Cloud_v2/README.md). A decisão continua nos fluxos da plataforma; o Raspberry Pi próximo dos dispositivos representa o Near Edge/Fog.
...
- [Node-RED: dashboard e comandos](../app15-Cloud_v2/Plataformas_config/NodeRED/Fluxo_1_dashboard_graphs_e_cmd.json)
- [Node-RED: InfluxDB opcional](../app15-Cloud_v2/Plataformas_config/NodeRED/Fluxo_2_envio_InfluxDB.json)
- [n8n: notificações](../app15-Cloud_v2/Plataformas_config/n8n/fluxo_mqtt.json)
