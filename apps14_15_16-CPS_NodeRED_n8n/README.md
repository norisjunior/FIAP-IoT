...
|---|---|---|
| [App14](app14_CPS_e_Automation_v2/README.md) | Projeto-base: coleta e publicação MQTT | Fluxos, Debug, gauges, gráficos e eventos |
| [App15](app15-Cloud_v2/README.md) | Acrescentar somente callback e assinatura MQTT ao app14 | Regras enviam ON/OFF ao LED |
| [App16](app16-Edge_v2/README.md) | Mesmo firmware preparado no app15 | Mesmos fluxos executados no Raspberry Pi |

O projeto embarcado está em `app14_CPS_e_Automation_v2/app14_NexoLog`. O app15 contém o roteiro das alterações e as configurações da plataforma. O app16 contém somente a orientação de implantação no Raspberry.
...
Os originais de `FIAP-IoT-eval` e os PPTX continuam intactos. Cópias de firmware e exemplos antigos que saíram desta sequência foram arquivados fora do projeto.

[Memória do projeto](NovoProjetoCPSCloudEdge.md) · [Sugestões para os slides](SugestoesSlides.md)
