...
Parta de uma cópia do projeto [app14_NexoLog](../app14_CPS_e_Automation_v2/app14_NexoLog). Mantenha sensores, coleta, JSON e tópicos de dados. Acrescente somente a recepção de comandos para o LED.
...
[Montagem e configuração comuns](../README.md)
