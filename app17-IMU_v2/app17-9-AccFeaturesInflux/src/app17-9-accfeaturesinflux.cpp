/* =====================================================================
 * app17-9-accfeaturesinflux.cpp  —  FORMA 1: Edge Analytics no dispositivo
 *
 * O QUE FAZ
...
/* Sensor: o codigo de aula usa MPU6500 (FastIMU). Se o seu sensor for
 * o MPU6050 original (GY-521), troque o #define abaixo. */
...
void loop() {
  ...
  if (millis() - tempoAnterior >= AMOSTRA_MS) {
    ...
    // sem espacamento real. Recomeça do agora.
