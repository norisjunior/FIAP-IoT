...
#include "AIoTRandomForest_micromlgen.hpp"   // Modelo Random Forest micromlgen (MUDANÇA: era mc2gen)
...
/* ==== INSTÂNCIA DO MODELO MICROMLGEN =================================== */
...
bool coletaDados_e_realizaInferencia() {
  ...
  // MUDANÇA: micromlgen não fornece probabilidades, apenas a classe predita
  Serial.printf("  --> Classe predita: %d", predicao); Serial.println("");
...
void setup() {
  ...
  Serial.println("Biblioteca: MICROMLGEN"); // MUDANÇA: Identificar que está usando micromlgen
  Serial.println("==========================================");
