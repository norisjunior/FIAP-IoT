...
#include "ESP32DisplayOLED.hpp"
#include "ESP32SensorsLED.hpp"

// -------------------- Configurações de Hardware --------------------
const uint8_t DHT_PIN   = 10;
const uint8_t DHT_MODEL = DHT22;
const uint8_t LED_PIN   = 6;
const uint8_t LED_RGB_PIN = 8;
const uint8_t BTN_PIN   = 7;
const uint8_t OLED_SDA_PIN = 11;
const uint8_t OLED_SCL_PIN = 12;
...
void setup() {
  ...
  ESP32Sensors::LED_RGB::inicializar(LED_RGB_PIN);
  pinMode(BTN_PIN, INPUT_PULLUP);

  ESP32Display::OLED::inicializar(OLED_SDA_PIN, OLED_SCL_PIN, OLED_ENDERECO);
...
void gravaMedicoes() {
  ...
  ESP32Display::OLED::exibirMedicoes(ambiente);
