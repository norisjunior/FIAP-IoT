/* Aplicacao 18 - VACCINE SENSE: COLETA VIA MQTT

   A caixa termica do 1o ano publica suas medicoes no broker, uma vez por
   segundo. Fluxo: SENSORES -> JSON -> BROKER -> Node-RED -> InfluxDB -> Colab.
   ...
   O que este app NAO faz: decidir se a carga esta em perigo. Essa decisao vem
   do modelo de ML, e chega a partir do app19. Aqui so coletamos o dataset.
*/
