...
#include "ESP32SensorsServo.hpp"     // Servo (simula bomba d'água)

namespace ESP32Sensors {
    void beginAll(uint8_t dhtPin, uint8_t dhtModel, uint8_t ledPin, uint8_t drynessPin, uint8_t servoPin) {
